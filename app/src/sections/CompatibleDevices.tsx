...
export function CompatibleDevices() {
  return (
    <section id="devices" className="relative border-y border-line bg-surface-2 py-24 sm:py-28">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <div className="reveal mx-auto mt-14 grid max-w-5xl gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-6">
          {groups.map((g) => {
            const Icon = g.icon;
            return (
        ...
        <p className="reveal mx-auto mt-14 max-w-xl text-center text-xs text-fg-subtle">
